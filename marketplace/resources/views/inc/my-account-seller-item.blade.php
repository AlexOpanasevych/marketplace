<div class="card border-black small" style="background-color: #ebebeb; margin-bottom: 30px; margin-right: 0; margin-left: 0">
    <div class="view overlay" style="font-size: 13px">
        <a class="chosen_cancel" href="{{route('remove-chosen', ['id' => $id])}}"><div><img height="25px" src="{{asset('img/delete_acc.svg')}}"></div></a>
        <a href="">
    ...
    <div class="mt-auto">
        ...
        <a href="{{route('promote-product')}}"><button style="width: 100%; font-size: 14px; height: 40px; color: white; background-color: #4F7CAC !important; margin: 5px 0 0;" class="btn  btn-lg btn-block">
            Просувати товар
            </button></a>
    </div>
</div>
