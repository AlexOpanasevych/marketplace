            ...
            @if($loop -> first)
                <div class=" d-flex align-items-center" style="height: 50px; border-bottom: silver 2px solid; border-top: silver 2px solid">
                    <div class="row d-flex align-items-center" style="width: 100%; padding: 0; margin: 0; font-size: 12px">
                        <div class="col-md-4">Користувач: ххххх </div>
                        <div class="col-md-4">Назва компанії (ФОП): ххххх</div>
                        <div class="col-md-4 d-flex justify-content-end" style="font-size: 10px">
                            <button style="margin-right: 5px; min-width: 100px; font-size: 12px; font-weight: bold" type="button" class="btn btn-danger ">Забрати статус продавця</button>
                            <button style=" min-width: 100px; font-size: 12px; font-weight: bold" type="button" class="btn btn-danger ">Заблокувати товари</button>
                        </div>
                    </div>
                </div>
            @else
