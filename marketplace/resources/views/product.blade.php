            ...
            <div class="product_info">
                ...
                <div class="buy_product">
                    ...
                    <div class="favourite_icon" >
                        <a href="{{route('add-chosen', ['id', $item->id])}}">
					...
					c40.865-26.406,99.659-68.479,147.681-118.95C455.837,277.798,485,219.151,485,163.932C485,85.97,421.573,22.543,343.611,22.543z"/></svg></a>
                    </div>
                </div>
                <h1>Опис товару:</h1>
